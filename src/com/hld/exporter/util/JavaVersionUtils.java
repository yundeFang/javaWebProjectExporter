...
public class JavaVersionUtils {
    ...
    public static void main (String[] argus) throws Exception{
        ...
        System.out.println( getCompileVersion(new File("D:\\bbb\\BaseController1.7.class")) );
        System.out.println( getCompileVersion(new File("D:\\bbb\\BaseController1.8.class")) );
    }
}
